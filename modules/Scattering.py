...
# 壁, ゴール, スタートの描画ver.2
def scatman_v2(ax, wall_list, goal_list, goal_list_2, start_list, start_list_2, mix_list, mix_list_2):
    for w in wall_list:
        ax.scatter(w[1], w[0], s=100, marker=",", c="green")
    for g in goal_list:
    ...
    for m in mix_list_2:
        ax.scatter(m[1], m[0], s=60, marker="$❤️$", c="blue")
